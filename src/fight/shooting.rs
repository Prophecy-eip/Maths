...
mod tests {
    ...
    //         initialize_stats_w_ballistic(4, 8, 8, 1, 5, 4, 0, 0, 2, 4, 5, 1, 4),
    //         4,
    //         5,
    //         20,
    //         false,
    ...
    //         initialize_stats_w_ballistic(4, 8, 7, 1, 3, 3, 0, 0, 1, 3, 3, 0, 3),
    //         4,
    //         5,
    //         20,
    //         false,
    ...
    fn test_compute_turn_shoot() {
        ...
        assert_eq!(res.get_mean_case().get_attacking_regiment().get_points(), 4);
