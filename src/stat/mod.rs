...
mod tests {
    ...
    fn model_get_boosted_stats() {
        ...
        let model: model::Model = model::Model::new(stats, vec![], false);
    ...
    fn model_get_stats() {
        let stats: Stats = global_test::tests::initialize_mock_stats();
        let model: model::Model = model::Model::new(stats.clone(), vec![], false);
    ...
    fn test_model_banner_bearing() {
        let stats: Stats = global_test::tests::initialize_mock_stats();
        let model: model::Model = model::Model::new(stats.clone(), vec![], true);
        let second_model: model::Model = model::Model::new(stats, vec![], false);
