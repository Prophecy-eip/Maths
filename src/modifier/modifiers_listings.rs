...
///
    static ref HASHMAP: std::collections::HashMap<modifier_list::ModifierList, (crate::modifier::Modifier, modifier_check::ModifierCheck)> = {
        ...
        m.insert(modifier_list::ModifierList::OnyxCore, (crate::modifier::Modifier::new_offensive(0, 0, 6, 0, 0), modifier_check::ModifierCheck::AlwaysTrue(true)));
        ...
        m.insert(modifier_list::ModifierList::BlazeOfProtection, (crate::modifier::Modifier::new_defensive(0, 0, 0, 3, 0), modifier_check::ModifierCheck::AlwaysTrue(true)));
        ...
        m.insert(modifier_list::ModifierList::BreathOfTheBrassBull, (crate::modifier::Modifier::new_defensive(1, 0, 0, 0, 0), modifier_check::ModifierCheck::AlwaysTrue(true)));
        m.insert(modifier_list::ModifierList::GoldenIdolOfShamut, (crate::modifier::Modifier::new_global(4, 12, 0), modifier_check::ModifierCheck::AlwaysTrue(true)));
        m.insert(modifier_list::ModifierList::MaskOfAges, (crate::modifier::Modifier::new_defensive(0, 0, 0, 0, 5), modifier_check::ModifierCheck::AlwaysTrue(true)));
        ...
        m.insert(modifier_list::ModifierList::LegendOfTheBlackKing, (crate::modifier::Modifier::new_defensive(0, 0, 0, 1, 4), modifier_check::ModifierCheck::AlwaysTrue(true)));
        ...
        m.insert(modifier_list::ModifierList::ReaperSHarvest, (crate::modifier::Modifier::new_offensive(0, 0, 10, 10, 0), modifier_check::ModifierCheck::AlwaysTrue(true)));
        m.insert(modifier_list::ModifierList::TrueThirst, (crate::modifier::Modifier::new_offensive(0, 0, 1, 1, 0), modifier_check::ModifierCheck::AlwaysTrue(true)));
        ...
        m.insert(modifier_list::ModifierList::Strigoi, (crate::modifier::Modifier::new_defensive(4, 0, 0, 0, 0), modifier_check::ModifierCheck::AlwaysTrue(true)));
        ...
        m.insert(modifier_list::ModifierList::GhoulLord, (crate::modifier::Modifier::new_offensive(0, 6, 0, 0, 0), modifier_check::ModifierCheck::AlwaysTrue(true)));
        ...
        m.insert(modifier_list::ModifierList::OakenMight, (crate::modifier::Modifier::new_offensive(0, 0, 3, 0, 0), modifier_check::ModifierCheck::AlwaysTrue(true)));
        ...
        m.insert(modifier_list::ModifierList::HunterSHonour, (crate::modifier::Modifier::new_offensive(0, 0, 1, 1, 0), modifier_check::ModifierCheck::AlwaysTrue(true)));
        ...
        m.insert(modifier_list::ModifierList::SpiritOfTheWhirlwind, (crate::modifier::Modifier::new_offensive(1, 0, 1, 0, 0), modifier_check::ModifierCheck::AlwaysTrue(true)));
        m.insert(modifier_list::ModifierList::ShieldingBark, (crate::modifier::Modifier::new_defensive(0, 0, 0, 1, 5), modifier_check::ModifierCheck::AlwaysTrue(true)));
        ...
        m.insert(modifier_list::ModifierList::HailShot, (crate::modifier::Modifier::new_weapon(Some(30), Some(9), 4, 1), modifier_check::ModifierCheck::AlwaysTrue(true)));
        ...
        m.insert(modifier_list::ModifierList::GlyphOfAmryl, (crate::modifier::Modifier::new_defensive(0, 3, 0, 0, 0), modifier_check::ModifierCheck::AlwaysTrue(true)));
        ...
        m.insert(modifier_list::ModifierList::Pathfinder, (crate::modifier::Modifier::new_weapon(None, Some(3), 0, 0), modifier_check::ModifierCheck::AlwaysTrue(true)));
        m.insert(modifier_list::ModifierList::ForestGuardian, (crate::modifier::Modifier::new_defensive(0, 0, 0, 1, 0), modifier_check::ModifierCheck::AlwaysTrue(true)));
        m.insert(modifier_list::ModifierList::BladeDancer, (crate::modifier::Modifier::new_defensive(0, 0, 0, 0, 6), modifier_check::ModifierCheck::AlwaysTrue(true)));
        ...
        m.insert(modifier_list::ModifierList::CripplingFrost, (crate::modifier::Modifier::new_offensive(0, 0, 0, 0, 0), modifier_check::ModifierCheck::Function(modifier_check::crippling_frost)));
        ...
        m.insert(modifier_list::ModifierList::PrideOfGarDaecos, (crate::modifier::Modifier::new_offensive(1, 0, 0, 0, 0), modifier_check::ModifierCheck::AlwaysTrue(true)));
        m.insert(modifier_list::ModifierList::Transcendence, (crate::modifier::Modifier::new_offensive(0, 0, 1, 1, 0), modifier_check::ModifierCheck::AlwaysTrue(true)));
        m.insert(modifier_list::ModifierList::LaceratingTouch, (crate::modifier::Modifier::new_offensive(2, 0, 0, 2, 0), modifier_check::ModifierCheck::AlwaysTrue(true)));
        m.insert(modifier_list::ModifierList::SealOfTheRepublic, (crate::modifier::Modifier::new_defensive(0, 0, 0, 1, 0), modifier_check::ModifierCheck::AlwaysTrue(true)));
        ...
        m.insert(modifier_list::ModifierList::MoithirSMirror, (crate::modifier::Modifier::new_defensive(0, 0, 0, 0, 5), modifier_check::ModifierCheck::AlwaysTrue(true)));
        ...
        m.insert(modifier_list::ModifierList::Godslayer, (crate::modifier::Modifier::new_offensive(1, 0, 0, 0, 0), modifier_check::ModifierCheck::AlwaysTrue(true)));
        m.insert(modifier_list::ModifierList::ScourgeOfKings, (crate::modifier::Modifier::new_offensive(0, 6, 0, 0, 0), modifier_check::ModifierCheck::AlwaysTrue(true)));
        m.insert(modifier_list::ModifierList::JackalSBlessing, (crate::modifier::Modifier::new_defensive(2, 0, 0, 0, 0), modifier_check::ModifierCheck::AlwaysTrue(true)));
        ...
        m.insert(modifier_list::ModifierList::BlessedWrappings, (crate::modifier::Modifier::new_defensive(1, 0, 0, 0, 0), modifier_check::ModifierCheck::AlwaysTrue(true)));
        ...
        m.insert(modifier_list::ModifierList::SandstormCloak, (crate::modifier::Modifier::new_offensive(0, 0, 2, 1, 0), modifier_check::ModifierCheck::AlwaysTrue(true)));
        ...
        m.insert(modifier_list::ModifierList::BannerOfElan, (crate::modifier::Modifier::new_offensive(0, 0, 2, 2, 0), modifier_check::ModifierCheck::AlwaysTrue(true)));
        ...
        m.insert(modifier_list::ModifierList::TristanSResolve, (crate::modifier::Modifier::new_offensive(1, 0, 0, 1, 0), modifier_check::ModifierCheck::AlwaysTrue(true)));
        m.insert(modifier_list::ModifierList::MortalReminder, (crate::modifier::Modifier::new_offensive(0, 0, 1, 1, 0), modifier_check::ModifierCheck::AlwaysTrue(true)));
        m.insert(modifier_list::ModifierList::DivineJudgement, (crate::modifier::Modifier::new_offensive(0, 0, 2, 2, 0), modifier_check::ModifierCheck::AlwaysTrue(true)));
        ...
        m.insert(modifier_list::ModifierList::ChitinousScales, (crate::modifier::Modifier::new_defensive(0, 0, 0, 2, 0), modifier_check::ModifierCheck::AlwaysTrue(true)));
        ...
        m.insert(modifier_list::ModifierList::PiercingSpike, (crate::modifier::Modifier::new_offensive(0, 0, 0, 1, 0), modifier_check::ModifierCheck::AlwaysTrue(true)));
        ...
        m.insert(modifier_list::ModifierList::DiviningSnout, (crate::modifier::Modifier::new_global(2, 0, 0), modifier_check::ModifierCheck::AlwaysTrue(true)));
        ...
        m.insert(modifier_list::ModifierList::HotBlood, (crate::modifier::Modifier::new_offensive(0, 0, 0, 0, 2), modifier_check::ModifierCheck::AlwaysTrue(true)));
        ...
        m.insert(modifier_list::ModifierList::RedHaze, (crate::modifier::Modifier::new_offensive(0, 0, 1, 1, 0), modifier_check::ModifierCheck::AlwaysTrue(true)));
        m.insert(modifier_list::ModifierList::IncendiaryIchor, (crate::modifier::Modifier::new_defensive(0, 0, 0, 0, 3), modifier_check::ModifierCheck::AlwaysTrue(true)));
        ...
        m.insert(modifier_list::ModifierList::SerpentSNestCharm, (crate::modifier::Modifier::new_offensive(0, 6, 0, 0, 0), modifier_check::ModifierCheck::AlwaysTrue(true)));
        m.insert(modifier_list::ModifierList::GloryOfTheDawnAge, (crate::modifier::Modifier::new_offensive(0, 0, 1, 1, 0), modifier_check::ModifierCheck::AlwaysTrue(true)));
        m.insert(modifier_list::ModifierList::AlchemicalArrows, (crate::modifier::Modifier::new_weapon(None, Some(4), 4, 1), modifier_check::ModifierCheck::AlwaysTrue(true)));
        ...
        m.insert(modifier_list::ModifierList::VitalEssence, (crate::modifier::Modifier::new_defensive(1, 0, 0, 0, 0), modifier_check::ModifierCheck::AlwaysTrue(true)));
        ...
        m.insert(modifier_list::ModifierList::EngineOfTheAncients, (crate::modifier::Modifier::new_weapon(Some(12), Some(1), 6, 3), modifier_check::ModifierCheck::AlwaysTrue(true)));
        m.insert(modifier_list::ModifierList::LodestoneShield, (crate::modifier::Modifier::new_defensive(0, 0, 0, 0, 5), modifier_check::ModifierCheck::AlwaysTrue(true)));
        m.insert(modifier_list::ModifierList::MagneticGreatBow, (crate::modifier::Modifier::new_weapon(Some(18), Some(2), 4, 1), modifier_check::ModifierCheck::AlwaysTrue(true)));
        ...
        m.insert(modifier_list::ModifierList::SuncatcherCrystal, (crate::modifier::Modifier::new_offensive(0, 0, 4, 1, 0), modifier_check::ModifierCheck::AlwaysTrue(true)));
