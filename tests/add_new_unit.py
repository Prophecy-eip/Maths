...
with open('tests/initialize_units.rs', 'a') as f:
    ...
    f.write(f'    let {name}_stats: stat::Stats = stat::Stats::new(\n')
    f.write('        stat::GlobalStats {\n')
    f.write(f'            advance: {advance},\n')
    f.write(f'            march: {march},\n')
    f.write(f'            discipline: {discipline},\n')
    f.write('        },\n')
    f.write('        stat::DefensiveStats {\n')
    ...
    f.write(f'        modifier::Modifier::new_weapon(Some(3),None, 0, 0, None, false);\n')
